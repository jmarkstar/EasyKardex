...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product_category` (`id_category`, `name`, `creation_date`) VALUES (1, 'Golosinas', now() );
INSERT INTO `easy_kardex_db`.`product_category` (`id_category`, `name`, `creation_date`) VALUES (2, 'Gaseosas', now() );
INSERT INTO `easy_kardex_db`.`product_category` (`id_category`, `name`, `creation_date`) VALUES (3, 'Licores', now() );
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product_brand` (`id_brand`, `name`, `creation_date`) VALUES (1, 'Alicorp', now() );
INSERT INTO `easy_kardex_db`.`product_brand` (`id_brand`, `name`, `creation_date`) VALUES (2, 'Arcor', now() );
INSERT INTO `easy_kardex_db`.`product_brand` (`id_brand`, `name`, `creation_date`) VALUES (3, 'Ambrosoli', now() );
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`, `creation_date`) VALUES (1, 'Litro', now() );
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`, `creation_date`) VALUES (2, 'Kilo', now() );
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`, `creation_date`) VALUES (3, 'Pack x 6', now() );
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`, `creation_date`) VALUES (4, 'Pack x 12', now() );
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product` (`id_prod`, `id_brand`, `id_category`, `id_unit`, `name`, `image`, `thumb`, `description`, `creation_date`) VALUES (1, 1, 1, NULL, 'Casino', 'https://img.gestion.pe/files/article_content_ge_fotos/files/crop/uploads/2019/03/24/5c97c54cee8b3.r_1553648458233.0-0-568-318.jpeg', 'https://www.alicorp.com.pe/alicorp/userfiles/cms/pagina/imagen/marca/item/galletas_casino_coco.jpg', 'Es una galleta muy rica xD', now() );
INSERT INTO `easy_kardex_db`.`product` (`id_prod`, `id_brand`, `id_category`, `id_unit`, `name`, `image`, `thumb`, `description`, `creation_date`) VALUES (2, 3, 1, NULL, 'Mentitas', 'https://www.elparana.com/wp-content/uploads/2016/05/mentitas-de-ambrosoli.jpg', '', 'Son caramelos de menta', now() );
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`provider` (`id_provider`, `company_name`, `contact_name`, `contact_phone`, `creation_date`) VALUES (1, 'Ambrosoli', 'Jorge Perez', '999555333', now() );
INSERT INTO `easy_kardex_db`.`provider` (`id_provider`, `company_name`, `contact_name`, `contact_phone`, `creation_date`) VALUES (2, 'Arcor', 'Maria Perea', '987412523', now() );
