...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product_category` (`id_category`, `name`) VALUES (1, 'Golosinas');
INSERT INTO `easy_kardex_db`.`product_category` (`id_category`, `name`) VALUES (2, 'Gaseosas');
INSERT INTO `easy_kardex_db`.`product_category` (`id_category`, `name`) VALUES (3, 'Licores');
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product_brand` (`id_brand`, `name`) VALUES (1, 'Alicorp');
INSERT INTO `easy_kardex_db`.`product_brand` (`id_brand`, `name`) VALUES (2, 'Arcor');
INSERT INTO `easy_kardex_db`.`product_brand` (`id_brand`, `name`) VALUES (3, 'Ambrosoli');
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`) VALUES (1, 'Kilo');
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`) VALUES (2, 'Litro');
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`) VALUES (3, 'Caja x12');
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`) VALUES (4, 'Caja x6');
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`) VALUES (5, 'Paquete x6');
INSERT INTO `easy_kardex_db`.`product_unit` (`id_unit`, `name`) VALUES (7, 'Paquete x12');
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`product` (`id_prod`, `id_brand`, `id_category`, `id_unit`, `name`, `image`, `thumb`, `description`) VALUES (1, 1, 1, NULL, 'Casino', 'https://img.gestion.pe/files/article_content_ge_fotos/files/crop/uploads/2019/03/24/5c97c54cee8b3.r_1553648458233.0-0-568-318.jpeg', 'https://www.alicorp.com.pe/alicorp/userfiles/cms/pagina/imagen/marca/item/galletas_casino_coco.jpg', 'Es una galleta muy rica xD');
INSERT INTO `easy_kardex_db`.`product` (`id_prod`, `id_brand`, `id_category`, `id_unit`, `name`, `image`, `thumb`, `description`) VALUES (2, 3, 1, NULL, 'Mentitas', 'https://www.elparana.com/wp-content/uploads/2016/05/mentitas-de-ambrosoli.jpg', '', 'Son caramelos de menta');
...
START TRANSACTION;
USE `easy_kardex_db`;
INSERT INTO `easy_kardex_db`.`provider` (`id_provider`, `company_name`, `contact_name`, `contact_phone`) VALUES (1, 'Ambrosoli', 'Jorge Perez', '999555333');
INSERT INTO `easy_kardex_db`.`provider` (`id_provider`, `company_name`, `contact_name`, `contact_phone`) VALUES (2, 'Arcor', 'Maria Perea', '987412523');
